...
// NewARKBlockScanner create a block scanner
func NewARKBlockScanner(wm *WalletManager) *ARKBlockScanner {
	bs := ARKBlockScanner{
...
func (bs *ARKBlockScanner) getCurrentBlock() (*client.Block, error) {
...
func (bs *ARKBlockScanner) GetGlobalMaxBlockHeight() uint64 {
...
func (bs *ARKBlockScanner) getBlockByHeight(height uint64) (*client.Block, error) {
...
func (bs *ARKBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *ARKBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *ARKBlockScanner) getTransactionsByBlock(hash string) (*client.Transactions, error) {
...
//GetBlockHeight 获取区块链高度
func (bs *ARKBlockScanner) GetBlockHeight() (uint64, error) {
	//暂时只有一个接口获取钱包高度
	return bs.GetGlobalMaxBlockHeight(), nil
}

//newBlockNotify 获得新区块后，通知给观测者
func (bs *ARKBlockScanner) newBlockNotify(block *client.Block, isFork bool) {
...
func (bs *ARKBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *ARKBlockScanner) ExtractTransaction(block *client.Block, scanTargetFunc openwallet.BlockScanTargetFunc) (ExtractResult, error) {
...
//ExtractTransaction 提取交易单
func (bs *ARKBlockScanner) ExtractTransactionSingleTx(block *client.Block, tx *client.Transaction, scanTargetFunc openwallet.BlockScanTargetFunc) (ExtractTxResult, error) {
	return bs.changeTrans(tx, scanTargetFunc)

}

func (bs *ARKBlockScanner) changeTrans(trans *client.Transaction, scanTargetFunc openwallet.BlockScanTargetFunc) (ExtractTxResult, error) {
	v := trans
...
func (bs *ARKBlockScanner) BatchExtractTransaction(block *client.Block) error {
...
func (bs *ARKBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *ARKBlockScanner) ScanBlock(height uint64) error {
...
//ScanBlock 扫描指定高度区块
func (bs *ARKBlockScanner) scanBlock(height uint64) (*client.Block, error) {
...
func (bs *ARKBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
